...
# sort the price in desecending order it will be easy to distribute the oreder
...
for i in output_list:
    ...
    sample_output.write("\n")
sample_output.write("And the difference between the chosen goodie with highest price and the lowest price is "+5)
sample_output.write("\n\n\n")
